...
def view(request, id):  #blog/폴더아래 blog_write.html페이지로 이동
    sql = "select * from blog_blog where id=" +id #직접안하겠다
    blog = Blog.objects.get(id)
    return render(request, "blog/blog_write.html", {"blog":datasets})
